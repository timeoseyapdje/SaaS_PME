...
const features = [
  ...
  },
  {
    ...
    description: "Gerez votre inventaire, fixez des seuils d'alerte et suivez chaque mouvement de stock en temps reel.",
    icon: Package,
    color: "text-amber-500",
    bg: "bg-amber-500/10",
  },
  {
    ...
    description: "Creez, suivez et convertissez vos commandes en factures. Deduction automatique du stock a la confirmation.",
    icon: ShoppingCart,
  ...
  },
  {
    ...
    description: "Generez des liens de paiement partageables (WhatsApp, email) pour encaisser via Mobile Money en quelques secondes.",
    icon: Link2,
  ...
  {
    title: "Nkap AI — assistant integre",
    description: "Posez vos questions financieres en francais. L'IA analyse vos donnees et vous guide vers les meilleures decisions.",
    icon: Zap,
    color: "text-cyan-500",
    bg: "bg-cyan-500/10",
  },
...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Catalogue produits & gestion du stock",
      "Commandes & liens de paiement",
  ...
  },
  {
    ...
    features: [
      ...
      "Tout du plan Pro",
      "Nkap AI illimite",
      "Multi-boutiques & multi-entrepots",
